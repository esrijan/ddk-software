 ...
 * ATmega16/32
 * 
 * AVR Serial Programmer Demo using RESET, SCK, MISO, MOSI lines of target
 * ATmega16
...
int main(void)
{
	...
	while (1)
	{
		...
		{
			TL_ON;
			debug_print_string("Serial Pgming");
			setup_serial_programming();
