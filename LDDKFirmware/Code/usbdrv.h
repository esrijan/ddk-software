...
#ifndef USB_CFG_HAVE_INTROUT_ENDPOINT
#define USB_CFG_HAVE_INTROUT_ENDPOINT   0
#endif

#ifndef USB_CFG_HAVE_INTROUT_ENDPOINT3
#define USB_CFG_HAVE_INTROUT_ENDPOINT3   0
#endif

#if (USB_CFG_HAVE_INTROUT_ENDPOINT != 0) || (USB_CFG_HAVE_INTROUT_ENDPOINT3 != 0)
#if (USB_CFG_IMPLEMENT_FN_WRITEOUT == 0)
#error With INTROUT endpoints defined, USB_CFG_IMPLEMENT_FN_WRITEOUT should be set to 1
#endif
#endif
